...
export default async function trackMiddleware(req, res, next) {
  console.log("Middleware triggered for /track");
  ...
  try {
    ...
    const orderId = req.body?.message?.order_id; ///NEED TO LOOK THE LOCATION ------------
